...
if (!isset($_SESSION['customer_nik'])) {
    header('Location: index.php');
    exit();
}

$customer_nik = $_SESSION['customer_nik'];
...
$order_history = array_filter($transactions, function($transaction) use ($customer_nik) {
    return isset($transaction['customer_nik']) && $transaction['customer_nik'] === $customer_nik;
});
...
<body class="customer-dashboard">
    <div class="container">
        ...
        <div class="dashboard-header">
            ...
            <div class="user-info">
                <span><i class="fas fa-id-card"></i> NIK: <?php echo htmlspecialchars($customer_nik); ?></span>
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card info">
                ...
                <div class="stat-value"><?php echo count($order_history); ?></div>
                <div class="stat-label">Total Pesanan</div>
            </div>
            
            <div class="stat-card warning">
                <i class="fas fa-id-card"></i>
                <div class="stat-value"><?php echo substr($customer_nik, 12, 4); ?></div>
                <div class="stat-label">4 Digit NIK</div>
            </div>
            
            <div class="stat-card primary">
                <i class="fas fa-user"></i>
                <div class="stat-value"><?php echo substr($customer_name, 0, 1); ?></div>
                <div class="stat-label">Inisial Nama</div>
            </div>
        </div>
