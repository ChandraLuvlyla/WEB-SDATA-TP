...
switch($action) {
    case 'export_transactions':
        ...
        fputcsv($output, ['No. Pesanan', 'Nama Pelanggan', 'NIK Pelanggan', 'Subtotal', 'Pajak', 'Total', 'Makanan', 'Minuman', 'Status', 'Metode Bayar', 'Tanggal']);
    ...
    case 'export_customers':
        global $CUSTOMERS;
        header('Content-Type: text/csv');
        header('Content-Disposition: attachment; filename="data_pelanggan.csv"');
        
        $output = fopen('php://output', 'w');
        fputcsv($output, ['Nama', 'NIK', 'Password (4 digit terakhir)']);
    ...
    case 'generate_report':
        ...
        <body>
            ...
            <div class="report-section">
                ...
                <table>
                    <tr><th>No. Pesanan</th><th>Pelanggan</th><th>NIK</th><th>Subtotal</th><th>Pajak</th><th>Total</th><th>Status</th><th>Metode Bayar</th><th>Waktu</th></tr>
        ';
        ...
        foreach($daily_report['transactions'] as $transaction) {
            ...
            $html .= '<tr>
                ...
                <td>' . $transaction['customer_nik'] . '</td>
    ...
    case 'reset_data':
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $_SESSION['message'] = [
                'type' => 'success',
                'text' => "Semua data transaksi telah direset!"
            ];
            ...
            <body>
                <div class="confirmation">
                    ...
                    <p><strong>Peringatan:</strong> Tindakan ini akan menghapus semua data transaksi.</p>
